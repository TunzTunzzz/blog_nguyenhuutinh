            ...
            <div className="space-y-6">
                ...
                <div className="relative group">
                  <div className="w-32 h-32 md:w-40 md:h-40 border-2 border-black p-1 bg-white shadow-hard group-hover:shadow-none group-hover:translate-x-1 group-hover:translate-y-1 transition-all duration-200">
                    ...
                    <img
                      ...
                      className="w-full h-full object-cover border border-black transition-all"
                    />
                  </div>
                  {/* Sticker trang trí */}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  {/* Email */}
                  <a href="/contact" className="flex items-center gap-2 bg-white border-2 border-black px-3 py-2 shadow-hard-sm hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all text-sm font-bold hover:bg-black hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                    Email
                  </a>

                  {/* Phone */}
                  <div className="flex items-center gap-2 bg-white border-2 border-black px-3 py-2 shadow-hard-sm text-sm font-bold cursor-default">
