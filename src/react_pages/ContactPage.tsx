    ...
    <>
      <div className="max-w-2xl mx-auto animate-fade-in">
        <div className="bg-white border-2 border-black shadow-hard p-6 md:p-10 relative">
          ...
          <form
            action="https://formspree.io/f/mgoeevwg"
            method="POST"
            className="space-y-6"
          >
            ...
            <div className="space-y-2">
              ...
              <select
                name="subject"
                className="w-full bg-cream border-2 border-black p-3 font-medium focus:outline-none focus:shadow-hard focus:-translate-y-1 focus:-translate-x-1 transition-all"
              >
                <option>{t('contact.subject.collab')}</option>
                <option>{t('contact.subject.recruit')}</option>
                <option>{t('contact.subject.faq')}</option>
